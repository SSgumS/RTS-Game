package Units.Building.LumberCamp;
...
public class LumberCamp extends Building {
    ...
    private static int staticOriginalXHint = 42;
    private static int staticOriginalYHint = 94;
    public static int staticXHint = 42;
    public static int staticYHint = 94;
    private static BufferedImage[] construction;
    private static BufferedImage[] destroyed;

    static {
        File[] files = new File("resources\\images\\lumber camp").listFiles();
    ...
    public LumberCamp(GameCell cell, Player owner) {
        super(cell, owner, 2);
